<script>
  ...
  // Local to the generator by design (architecture.md Decision 1 — recurrence inside one window
  // gets a local component, not a shared primitive); the label and circle come from MainStat so
