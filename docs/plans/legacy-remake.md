...
| **Next** | **Nothing — the ledger is complete (R0–R7 done, 2026-08-13).** The remade system ships; S9 (psg-core.md) holds the remaining UI work. Commits and the `archive/legacy-core` branch/tag are local: **push pending**. |
